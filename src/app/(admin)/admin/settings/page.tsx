...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center justify-start lg:justify-center gap-1 p-1 bg-cream/50 ring-1 ring-warm-sand/30 rounded-2xl overflow-x-auto no-scrollbar animate-fade-in-up">
        {TABS.map((tab) => (
          <button
            key={tab.id}
            onClick={() => {
