...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen text-[#3f3328] font-sans selection:bg-[#c85a2d] selection:text-white overflow-x-hidden">
      ...
      <section className="-mt-[6rem] pt-[6rem] relative min-h-[100dvh] w-full bg-white text-[#3f3328] overflow-hidden">
        <div className="relative z-10 grid lg:grid-cols-12 min-h-[100dvh] max-w-[1800px] mx-auto px-6 md:px-12 pt-24 pb-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center lg:pr-12 xl:pr-24">
            ...
            {/* Main Headline */}
            <h1 className="relative font-display text-[15vw] sm:text-[13vw] lg:text-[10vw] xl:text-[160px] leading-[0.8] font-black tracking-[-0.04em] text-[#2d241c] mb-6 sm:mb-10 mix-blend-darken animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 fill-mode-both">
              MODERN
            ...
            <div className="relative w-full h-full max-w-[600px]">
              ...
              <div className="absolute -bottom-6 -left-6 z-20 bg-[#f5f1ed] p-6 pr-10 rounded-tr-[40px] shadow-lg border border-[#e8dcc8]">
                <div className="flex flex-col">
                  <span className="font-display text-5xl font-black text-[#c85a2d] leading-none">100%</span>
                  <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#3f3328] mt-2">Cotton Milk Premium</span>
                </div>
               ...
               <div className="absolute top-12 -right-4 md:-right-8 z-30 w-20 h-20 md:w-24 md:h-24 bg-[#2d241c] rounded-full flex items-center justify-center text-[#f5f1ed] text-center animate-[spin_10s_linear_infinite]">
                  <svg viewBox="0 0 100 100" width="100" height="100" className="w-full h-full absolute inset-0">
      ...
      */}
      <div className="w-full bg-white relative z-10 py-12 overflow-hidden pointer-events-none">
        ...
        <div className="animate-marquee-ltr flex items-center gap-24 min-w-full opacity-10">
           <span className="text-[120px] font-display font-black leading-none text-[#2d241c] whitespace-nowrap">MINDFULNESS</span>
           <span className="text-[120px] font-display font-black leading-none text-transparent stroke-text whitespace-nowrap" style={{ WebkitTextStroke: '2px #2d241c' }}>HANDMADE</span>
           <span className="text-[120px] font-display font-black leading-none text-[#2d241c] whitespace-nowrap">SERENITY</span>
           <span className="text-[120px] font-display font-black leading-none text-transparent stroke-text whitespace-nowrap" style={{ WebkitTextStroke: '2px #2d241c' }}>CONNECTION</span>
        </div>
      </div>
        ...
        <div className="px-6 md:px-12 max-w-[1600px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8 relative z-10">
            <div className="relative">
              ...
              <span className="block text-[#c85a2d] font-bold tracking-[0.3em] uppercase text-xs mb-4 pl-1">Selected Works</span>
              <h2 className="font-display text-5xl md:text-6xl font-black text-[#2d241c]">
                Kurasi <span className="font-serif italic font-medium text-[#c85a2d]">Terpilih</span>
              </h2>
            </div>
            ...
            >
              <span className="text-sm font-bold tracking-widest uppercase">Lihat Katalog</span>
      ...
      */}
      <section id="story" className="py-32 md:py-48 bg-white relative overflow-hidden">
        ...
        <div className="px-6 md:px-12 max-w-[1700px] mx-auto relative z-10">
          ...
          <div className="text-center mb-24 md:mb-40 relative">
             ...
             <h2 className="font-display text-[12vw] md:text-[140px] leading-[0.8] font-black text-[#2d241c] mt-8 tracking-tighter mix-blend-multiply relative z-10">
               THE <span className="text-transparent stroke-text" style={{ WebkitTextStroke: '1px #2d241c' }}>ARTISAN</span> WAY
             </h2>
          ...
          <div className="space-y-32 md:space-y-0">
             ...
             <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24 relative">
                   ...
                   <div className="aspect-[4/5] relative rounded-[4rem] overflow-hidden bg-[#f3efe9] shadow-2xl border border-white/50">
                      ...
                      <div className="absolute inset-0">
                         ...
                         <div className="absolute inset-0 flex items-center justify-center p-8">
                            <svg viewBox="0 0 200 240" fill="none" className="w-full h-full drop-shadow-xl">
                               {/* Yarn Ball 1 (Sage) */}
                               <circle cx="60" cy="80" r="45" fill="#7a9d7f" className="opacity-90" />
                               <path d="M60 35c24.8 0 45 20.2 45 45s-20.2 45-45 45S15 104.8 15 80s20.2-45 45-45z" stroke="#fff" strokeWidth="0.5" strokeOpacity="0.3" />
                               <path d="M40 50 Q 80 50, 80 110" stroke="white" strokeWidth="1" strokeLinecap="round" className="opacity-40" />
                               <path d="M30 70 Q 90 70, 70 100" stroke="white" strokeWidth="1" strokeLinecap="round" className="opacity-40" />

                               {/* Yarn Ball 2 (Terracotta - Center overlap) */}
                               <circle cx="130" cy="110" r="55" fill="#c85a2d" className="opacity-95" />
                               <path d="M130 55c30.4 0 55 24.6 55 55s-24.6 55-55 55-55-24.6-55-55 24.6-55 55-55z" stroke="#fff" strokeWidth="0.5" strokeOpacity="0.3" />
                               <path d="M100 90 Q 160 80, 160 140" stroke="white" strokeWidth="1.5" strokeLinecap="round" className="opacity-40" />
                               <path d="M110 130 Q 150 100, 170 130" stroke="white" strokeWidth="1.5" strokeLinecap="round" className="opacity-40" />

                               {/* Loose Thread Connection */}
                               <path d="M130 165 C 130 200, 70 150, 70 200" stroke="#c85a2d" strokeWidth="3" strokeLinecap="round" fill="none" className="drop-shadow-sm" />
                            </svg>
                         </div>
                      </div>
                      ...
                      <div className="absolute bottom-8 right-8 bg-white/60 backdrop-blur-md border border-white/60 p-5 rounded-3xl shadow-lg max-w-[180px] z-10 transition-transform duration-500 hover:-translate-y-2">
                         ...
                         <p className="text-[10px] uppercase tracking-widest text-[#8b7b6b] mt-1">Soft Touch</p>
                      </div>
                   </div>
                </div>
                <div className="w-full md:w-5/12 pt-12 md:pt-0">
                   ...
                   <p className="text-lg text-[#6b5b4b] leading-relaxed max-w-md">
                     Kami hanya menggunakan benang katun susu (milk cotton) premium yang lembut di kulit dan ramah lingkungan. Tanpa plastik berlebih, kembali ke alam.
                   </p>
                </div>
             </div>
             ...
             <div className="flex flex-col md:flex-row-reverse items-center justify-end gap-12 md:gap-24 relative md:-mt-20">
                   ...
                   <div className="aspect-square relative rounded-full overflow-hidden bg-[#2d241c] border-8 border-white shadow-2xl flex items-center justify-center">
                      ...
                      <div className="relative w-full h-full p-12">
                         ...
                         <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-2xl">
                            {/* Stylized Hook */}
                            <path d="M70 20 L50 40 L30 20" stroke="transparent" fill="none" /> 
                            <path d="M60 10 C60 10, 65 5, 70 10 C 75 15, 70 20, 65 25 L 35 65 C 30 72, 25 80, 30 85 C 35 90, 45 90, 50 85" stroke="#e8dcc8" strokeWidth="4" strokeLinecap="round" fill="none" className="drop-shadow-lg" />
                            
                            {/* The Loop / Thread being pulled */}
                            <path d="M40 55 C 20 50, 10 30, 30 20 C 50 10, 60 30, 50 45" stroke="#c85a2d" strokeWidth="3" fill="none" strokeDasharray="5 3" className="opacity-80" />
                            
                            {/* "Magic Ring" Circle */}
                            <circle cx="50" cy="50" r="35" stroke="white" strokeWidth="0.5" fill="none" opacity="0.1" />
                         </svg>

                         {/* Number Overlay */}
                         <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <span className="font-display font-black text-white/10 text-[180px] leading-none select-none blur-[1px]">02</span>
                         </div>
                      </div>
                ...
                <div className="w-full md:w-5/12 text-right">
                   ...
                   <p className="text-lg text-[#6b5b4b] leading-relaxed max-w-md ml-auto">
                     Tidak ada mesin. Hanya tangan-tangan terampil pengrajin lokal yang mendedikasikan 8-12 jam untuk satu karakter. Ketidaksempurnaan adalah tanda keaslian.
                   </p>
                </div>
             </div>
             ...
             <div className="flex flex-col items-center text-center pt-24 md:pt-40 relative">
                ...
                <div className="max-w-4xl relative">
                   <span className="absolute -top-12 left-1/2 -translate-x-1/2 text-[200px] leading-none text-[#f5f1ed] -z-10 font-display font-black select-none">03</span>
                   ...
                   <p className="text-xl md:text-2xl text-[#6b5b4b] leading-relaxed font-medium">
                     &quot;Diciptakan dengan intensi positif. Setiap karakter dirancang untuk membawa senyum dan ketenangan, menjadi <span className="text-[#c85a2d] italic font-serif">anchor visual</span> saat Anda kehilangan fokus.&quot;
                   </p>
                </div>
             </div>
            ...
            <div className="order-2 lg:order-1 flex flex-col items-start">
              ...
              <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-black leading-[0.9] tracking-tight mb-10">
                ...
                <span className="text-[#c85a2d] font-serif italic font-medium relative inline-block">
                  turun ke bawah
                  <svg className="absolute w-full h-3 -bottom-1 left-0 text-[#c85a2d]" viewBox="0 0 200 9" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.00025 6.99997C25.7533 3.97825 80.8932 0.380722 198.001 2.00002" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/></svg>
                </span>
                .&quot;
              </h2>
              
              <div className="flex gap-4">
                 <div className="w-16 h-16 rounded-full border border-[#f5f1ed]/20 flex items-center justify-center text-2xl font-serif italic text-[#c85a2d]">Y</div>
                 <div className="h-16 w-px bg-[#f5f1ed]/20"></div>
                 <p className="flex-1 text-lg text-[#f5f1ed]/80 leading-relaxed max-w-sm">
                   Setiap karya kami adalah pengingat visual untuk tetap hadir di sini, saat ini.
                 </p>
              </div>
            </div>
